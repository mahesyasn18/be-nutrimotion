<x-app-layout title="Add Food" is-header-blur="true">
                        ...
                        <div class="space-y-4 p-4 sm:p-5">
                            ...
                            <div x-show="step === 1">
                                <div class="grid grid-cols-1 gap-4">
                                    <div class="grid grid-cols-2 gap-4">
                                        <label for="food_name" class="block">
                                            <span>Food Name</span>
                                            <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" name="food_name" id="food_name" placeholder="Enter food name..." type="text" />
                                        </label>
        
                                        <label for="barcode_number" class="block">
                                            <span>Barcode</span>
                                            <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" name="barcode_number" id="barcode_number" placeholder="Enter food barcode..." type="number"/>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 mt-4">
                                    <label class="block">
                                        <span>Food Type</span>
                                        <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" name="food_type" id="food_type" placeholder="Enter food type..." type="text" />
                                    </label>
        
                                    <div class="grid grid-cols-2 gap-4">
                                        <label class="block">
                                            <span>Food Category</span>
                                            <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" name="food_category" id="food_category" placeholder="Enter food category..." type="text" />
                                        </label>
        
                                        <label class="block">
                                            <span>Size</span>
                                            <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" name="size" id="size" placeholder="Input size..." type="number" />
                                        </label>
                                    </div>
                                </div>
                                <div class="mt-4">
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                                    <label class="block col-span-2">
                                        ...
                                        <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                               name="per_serving" id="per_serving" placeholder="Per Serving..." type="number" />
                                    </label>
                                    <label class="block col-span-2">
