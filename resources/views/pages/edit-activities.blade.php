<x-app-layout title="Edit Activity" is-header-blur="true">
        ...
        <div class="mt-6 flex flex-col items-center justify-between space-y-2 text-center sm:flex-row sm:space-y-0 sm:text-left">
            <div class="flex items-center space-x-4 py-5 lg:py-6">
                ...
                <ul class="hidden flex-wrap items-center space-x-2 sm:flex">
                    ...
                    <li class="flex items-center space-x-2">
                        <a class="text-primary hover:underline" href="{{ route('edit-activity-form', $activity->id) }}">{{ $activity->activity_name }}</a> 
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="space-y-4 p-4 sm:p-5">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <label for="food_name" class="block">
                                ...
                                <input
                                    ...
                                    name="activity_name" id="activity_name" placeholder="Enter activity name..." type="text" value="{{ $activity->activity_name }}" />
                            </label>
                        </div>
                        ...
                        <div class="flex space-x-4">
                            <label class="flex-1 block">
                                ...
                                <input
                                    class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                    name="jumlah_kalori_rendah" id="jumlah_kalori_rendah" placeholder="Enter kalori rendah..." type="number" value="{{ $activity->jumlah_kalori_rendah }}"/>
                            </label>
                            ...
                            <label class="flex-1 block">
                                ...
                                <input
                                    class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                    name="jumlah_kalori_sedang" id="jumlah_kalori_sedang" placeholder="Enter kalori sedang..." type="number" value="{{ $activity->jumlah_kalori_sedang }}"/>
                            </label>
                            ...
                            <label class="flex-1 block">
                                ...
                                <input
                                    class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                    name="jumlah_kalori_tinggi" id="jumlah_kalori_tinggi" placeholder="Enter kalori tinggi..." type="number" value="{{ $activity->jumlah_kalori_tinggi }}"/>
                            </label>
                        </div>                        
                        <div class="flex justify-end space-x-2 pt-4">
                            <button type="submit" class="btn min-w-[7rem] bg-primary mt-20 font-medium text-white hover:bg-[#60F166] focus:bg-[#60F166] active:bg-[#60F166]">
                                Save
                            </button>
                        </div>
                    </div>
